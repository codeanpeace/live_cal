defmodule LiveCalWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LiveCalWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LiveCalWeb.Gettext, "errors", msg, opts)
    end
  end
